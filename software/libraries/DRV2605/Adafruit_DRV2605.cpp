...
boolean Adafruit_DRV2605::begin(const nrf_twi_mngr_t* i2c) {
  i2c_manager = i2c;
...
uint8_t Adafruit_DRV2605::readRegister8( uint8_t reg_addr) {
  uint8_t rx_buf = 0;
...
void Adafruit_DRV2605::writeRegister8( uint8_t reg_addr, uint8_t data) {
